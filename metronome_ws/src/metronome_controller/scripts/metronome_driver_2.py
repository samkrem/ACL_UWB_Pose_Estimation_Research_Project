...
class metronome_driver_2:
    def __init__(self):
        rospy.init_node("metronome_driver_2")
        self.az_el_angle_sub = rospy.Subscriber(
            "az_el_angle_2", Float32MultiArray, callback=self.az_el_angle_callback
        )
...
if __name__ == "__main__":
    rospy.loginfo("metronome_driver_2 is active")
    driver = metronome_driver_2()
