...
def generate_circular_waypoints(params, bounds):
    ...
    waypoints, rr_waypoints, metronome_poses_per_coord = create_trans_rot_waypoint(coordinates, el_spec, az_spec)
    return waypoints, rr_waypoints, metronome_poses_per_coord
...
def generate_params_bounds(option1, option2):
    ...
    if option1 == "Stationary":
        ...
        params1 = ((0,0), "snake_7")
        bounds1 = {'length': 8, 'step': 5}, {'length': 8, 'step': 5},  {'min': -150, 'max': 150, 'step': 5}, {'min': -80, 'max': 80, 'step': 5}  #{'min': -180, 'max': 180, 'step': 1},
